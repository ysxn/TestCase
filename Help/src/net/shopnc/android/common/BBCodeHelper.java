...
public class BBCodeHelper {
    ...
    // private static Pattern pattern_image2 =
    // Pattern.compile("\\[img=\\d{4},\\d{3}\\]([^\\[\\]]*)\\[/img\\]",
    // Pattern.MULTILINE);
    // private static Pattern pattern_image =
    // Pattern.compile("\\[img\\]([^\\[\\]]*)\\[/img\\]", Pattern.MULTILINE);
    ...
    public static String processURL(String src) {
        for (Matcher matcher = pattern_link.matcher(src); matcher.find(); matcher = pattern_link.matcher(src)) {
    ...
    public static String processNcsmiley(String src) {
        for (Matcher matcher = pattern_ncsmiley.matcher(src); matcher.find(); matcher = pattern_ncsmiley.matcher(src)) {
    ...
    public static String parseHtml(String str) {
        ...
        // regx = urls[i].substring(tagBeginIdx, tagEndIdx +
        // 1).replaceAll("\\[", "\\\\[");
    ...
    public static String processBBCode(String src) {
        ...
        result = processURL(result);
        result = processAttach(result).replaceAll("<img", "<img style=\"width:100%;\"");
        result = processNcsmiley(result);
        result = ignoreBBCode(result);
        return result;
    }
    ...
    public static void main(String[] args) {
        String src = "a[ncsmiley]http://www.tjitcast.com/image/cc.gif[/ncsmiley]a " + "ad[url=aaaa]aaaa[/url]fad  adsfad[ncsmiley]"
                + "http://www.tjitcast.com/image/dd.gif[/ncsmiley] opwer" + "[img]http://www.phpbb.com/images/phplogo.gif[/img]sadf[img]"
                + "http://www.phpbb.com/images/phplogo.gif[/img]sa[img]" + "http://www.phpbb.com/images/111.gif[/img]df" + "[url=bbb]bbb[/url]";
