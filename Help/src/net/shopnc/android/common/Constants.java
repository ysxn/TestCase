...
public final class Constants {
    ...
    /** 服务器IP */
    public static final String HOST = "www.shopnctest.com";// www.shopnctest.com//"10.0.2.2";//AVD
                                                           // test
    ...
    /** 应用上下文名 */
    public static final String APP = "/dx2app/app2";// /dx2app/app2//"/app_mob";//
    ...
    /** 茶座 */
    public static final String URL_HOME_TEAHOUSE = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=index2";

    /** 焦点 */
    public static final String URL_HOME_FOCUS = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=index3";

    /** 娱乐 */
    public static final String URL_HOME_ENTERTAINMENT = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=index4";

    /** 情感 */
    public static final String URL_HOME_EMOTIONAL = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=index5";

    /************************ 生活 **********************************************/
    /** 家装 */
    public static final String URL_LIVE_FIRST = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=second1";

    /** 美食 */
    public static final String URL_LIVE_SECOND = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=second2";

    /** 汽车 */
    public static final String URL_LIVE_THIRD = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=second3";

    /** 婚嫁 */
    public static final String URL_LIVE_FORTH = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=second4";

    /** 母婴 */
    public static final String URL_LIVE_FIFTH = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=second5";

    /** 女性 */
    public static final String URL_LIVE_SIXTH = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=second6";

    /************************ 信息 **********************************************/
    /** 人才 */
    public static final String URL_INFO_01 = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=third1";

    /** 房产 */
    public static final String URL_INFO_02 = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=third2";

    /** 二手 */
    public static final String URL_INFO_03 = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=third3";

    /** 促销 */
    public static final String URL_INFO_04 = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=third4";

    /** 活动 */
    public static final String URL_INFO_05 = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=third5";

    /** 团购 */
    public static final String URL_INFO_06 = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=third6";

    /************************ 商圈 **********************************************/
    /**
     * 搜索指定范围内的商家<br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/zuobiao.php?type=shop_list&lat
     * =39.1178&lng=117.15&r=2000<br/>
     * GET请求参数: lat（使用者纬度） lng（使用者经度） r（搜索半径范围，单位：米）500米、1000米、2000米或5000米<br/>
     * 响应数据：从近到远的商家信息包括shop_id,shop_name,shop_pic,shop_website,shop_lat,shop_lng
     * ,distance(距离，单位：米)<br/>
     */
     ...
     * 商家详细信息<br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/zuobiao.php?type=shop_detail&
     * shop_id=1<br/>
     * GET请求参数: shop_id（商家ID）<br/>
     * 响应数据:
     * 商家的所有信息包括shop_id,shop_name,shop_pic,shop_info,shop_address,shop_phone
     * ,shop_website,shop_lat,shop_lng<br/>
     */
     ...
     * 选定版块下的帖子列表<br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/topiclist.php?type=thread_list
     * &fid=2&pageno=1&pagesize=20
     */
    public static final String URL_BOARD_TOPIC_LIST = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=thread_list&fid=";

    /**
     * 选定版块下的置顶帖子列表 <br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/topiclist.php?type=top_thread
     * &fid=2&pageno=1&pagesize=20
     */
    public static final String URL_BOARD_TOPIC_TOP = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=top_thread&fid=";

    /**
     * 选定版块下的精华帖子列表<br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/topiclist.php?type=digest_thread
     * &fid=2&pageno=1&pagesize=20
     */
    public static final String URL_BOARD_TOPIC_DIGEST = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=digest_thread&fid=";

    /**
     * 选定版块下的帖子搜索:keyword字段为中文，需要经过url编码 <br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/topiclist.php?type=search_thread
     * &fid=2&keyword=1&pageno=1&pagesize=20<br/>
     * 说明：字符串中除了 -_. 之外的所有非字母数字字符都将被替换成百分号（%）后跟两位十六进制数，空格则编码为加号（+）。此编码与 WWW 表单
     * POST 数据的编码方式是一样的，同时与 application/x-www-form-urlencoded 的媒体类型编码方式一样。
     */
    public static final String URL_BOARD_TOPIC_SEARCH = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=search_thread&fid=";

    /**
     * 帖子详情-默认全部显示<br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/topiclist.php?type=thread_detail
     * &tid=3&pageno=1&pagesize=20<br/>
     * 响应数据：<br/>
     ...
     * "avatar_url": "xxx.jpg"
     */
    public static final String URL_TOPIC_DETAIL_DEFAULT = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=thread_detail&tid=";

    /**
     * 帖子详情-只看楼主<br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/topiclist.php?type=thread_detail
     * &tid=3&pageno=1&pagesize=20&addtype=only_owner
     */
    public static final String URL_TOPIC_DETAIL_LANDLOAD = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=thread_detail&addtype=only_owner&tid=";

    /**
     * 帖子详情-最新回复<br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/topiclist.php?type=thread_detail
     * &tid=3&pageno=1&pagesize=20&addtype=last_post
     */
    public static final String URL_TOPIC_DETAIL_REPLY = URL_COMMON_TOPIC_LIST + PARAM_TYPE + "=thread_detail&addtype=last_post&tid=";
     ...
     * 返回数据：<br/>
     * 成功返回200，分为两种情况：<br/>
     * 登陆成功返回sessionid字符串；{"code":"200","datas":[{"sessionid":
     * "7e54a80ab3ecbddfbd8e5e1a09ad1a35"}]}<br/>
     * 账号或密码错误，返回sessionid字段，值为aperror。<br/>
     * {"code":"200","datas":[{"sessionid":"aperror"}]}<br/>
     ...
     * 发帖<br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/topicpost.php?type=post&fid=板块id<br/>
     * 请求参数: <br/>
     * GET参数：type=post,fid=板块ID,img=1（当需要上传图片时，img需设为1，没图时候img字段可省略）<br/>
     * POST参数：subject(标题),author(发帖用户名),authorid(发帖用户ID),message(帖子主体信息),img[](
     * 上传图片信息，可上传多图)<br/>
     * 响应数据：<br/>
     ...
     * 回帖<br/>
     * 请求URL:
     * http://www.shopnctest.com/dx2app/app2/topicpost.php?type=reply&fid=板块id<br/>
