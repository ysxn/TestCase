...
public class SystemHelper {
    ...
    public static void createShortcut(Context context, Class<?> clazz) {
        ...
        // 快捷方式的名称
        shortcut.putExtra(Intent.EXTRA_SHORTCUT_NAME, context.getString(0/*
                                                                          * R.string
                                                                          * .
                                                                          * app_name
                                                                          */));
        ...
        // 快捷方式的图标
        ShortcutIconResource iconResource = Intent.ShortcutIconResource.fromContext(context, 0/*
                                                                                               * R
                                                                                               * .
                                                                                               * drawable
                                                                                               * .
    ...
    public static boolean hasShortCut(Context context) {
        ...
        Cursor cursor = resolver.query(Uri.parse(url), null, "title=?", new String[] {
            context.getString(0/* R.string.app_name */)
        }, null);
