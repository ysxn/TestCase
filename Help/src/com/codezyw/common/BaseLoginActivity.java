...
public class BaseLoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAccount = new EditText(this);
        mAccount.setSingleLine(true);
        mPassword = new EditText(this);
        mPassword.setInputType(EditorInfo.TYPE_TEXT_VARIATION_PASSWORD);
        mPassword.setSingleLine(true);
        mLoginMenu = new Button(this);
        mLogoutMenu = new Button(this);
        mNewAccountMenu = new Button(this);
    ...
    OnClickListener loginClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            DbHelper.getInstance(BaseLoginActivity.this).putString(JsonHelper.ACCOUNT, username);
            DbHelper.getInstance(BaseLoginActivity.this).putString(JsonHelper.PASSWORD, password);
            finish();
            return;
    ...
    OnClickListener logoutClickListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            DbHelper.getInstance(BaseLoginActivity.this).delete(JsonHelper.ACCOUNT);
            DbHelper.getInstance(BaseLoginActivity.this).delete(JsonHelper.PASSWORD);
            Intent i = new Intent(BaseLoginActivity.this, JsonHelper.class);
            startService(i);
            finish();
        }
    };
