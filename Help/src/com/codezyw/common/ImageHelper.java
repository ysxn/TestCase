...
public class ImageHelper {
     ...
     * @return
     * @see ImageHelper#getInputStreamFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOutMillis
     * @return
     * @see ImageHelper#getDrawableFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOut
     * @return
     * @see ImageHelper#getBitmapFromUrl(String, int, boolean)
     */
