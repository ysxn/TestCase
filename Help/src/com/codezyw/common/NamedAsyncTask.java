 ...
 * </p>
 */
public abstract class NamedAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, CLASS + " #" + mCount.getAndIncrement());
        }
    };
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link NamedAsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     *             {@link NamedAsyncTask.Status#RUNNING} or
     *             {@link NamedAsyncTask.Status#FINISHED}.
     * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
     * @see #execute(Runnable)
     */
    public final NamedAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     * @see #execute(Object[])
     */
    public final NamedAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class InternalHandler extends Handler {
        @SuppressWarnings({
                "unchecked", "RawUseOfParameterizedType", "rawtypes"
        })
        @Override
    ...
    @SuppressWarnings({
            "RawUseOfParameterizedType", "rawtypes"
    })
    private static class AsyncTaskResult<Data> {
        final NamedAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(NamedAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
