...
public class ImageCache extends ImageMemoryCache {
    ...
    public static final String DEFAULT_CACHE_FOLDER = new StringBuilder().append(Environment.getExternalStorageDirectory().getAbsolutePath())
            .append(File.separator).append("Trinea").append(File.separator).append("AndroidCommon").append(File.separator).append("ImageCache").toString();
     ...
     * @param primaryCacheThreadPoolSize getting data thread pool size of the
     *            primary cache
     * @param secondaryCacheMaxSize maximum size of the secondary cache
     * @param secondaryCacheThreadPoolSize getting data thread pool size of the
     *            secondary cache
     */
