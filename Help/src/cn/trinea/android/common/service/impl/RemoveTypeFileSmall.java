...
/**
 * Remove type when cache is full, data type of cache is string, and it
 * represents the path of a file.<br/>
 * <ul>
 * <li>if file is smaller, remove it first</li>
 * <li>if file is equal to each other, remove the one which is used less</li>
 * <li>if file is equal to each other and used count is equal, remove the one
 * which is first in</li>
 * </ul>
 * 
