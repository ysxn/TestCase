    ...
    public String getFileName(String imageUrl) {
        ...
        switch (timeRule) {
            ...
            case HOUR_OF_DAY_TO_MILLIS:
                time = ((now.get(Calendar.HOUR_OF_DAY) * 60 + now.get(Calendar.MINUTE)) * 60 + now.get(Calendar.SECOND)) * 1000 + now.get(Calendar.MILLISECOND);
                break;
            ...
            case HOUR_OF_DAY_TO_MINUTES:
                ...
                break;
            case HOUR_TO_MILLIS:
                time = ((now.get(Calendar.HOUR) * 60 + now.get(Calendar.MINUTE)) * 60 + now.get(Calendar.SECOND)) * 1000 + now.get(Calendar.MILLISECOND);
                break;
