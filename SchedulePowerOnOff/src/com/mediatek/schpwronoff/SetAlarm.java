...
public class SetAlarm extends PreferenceActivity
    ...
    /**lenovo-sw caijh, modify bug: 7866630, 7865181, begin*/
    private TimePickerDialog mDialog = null;
    /**lenovo-sw caijh, modify bug: 7866630, 7865181, end*/
    /**
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mTimePref) {
            /*Lenovo-sw wuzb1 add 2014-01-01 begin, fix VIPER-12691 show new dialog*/
            if (mDialog != null){
                mDialog.dismiss();
                mDialog = null;
            }
            mDialog = new TimePickerDialog(this, this, mHour, mMinutes, DateFormat.is24HourFormat(this));
            mDialog.show();
            /*Lenovo-sw wuzb1 add 2014-01-01 end, fix VIPER-12691 show new dialog*/
        }
    ...
    private void saveAlarm() {
        ...
        if(!Alarms.isAlarmTimeAllowed(this,mId,mEnabled,
                mHour,mMinutes,mRepeatPref.getDaysOfWeek())) {
            popAlarmInvalidToast(this);
            return;
        }
    ...
    /**
     *Lenovo-sw wuzb1 add 2013-09-11: show time invalidation check
     */
    static void popAlarmInvalidToast(Context context) {
        String toastText = context.getString(R.string.schpwr_time_invalid, Alarms.POWER_TIME_INTERVAL);
