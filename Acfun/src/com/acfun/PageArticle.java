...
public class PageArticle extends ListActivity implements OnClickListener {
    private static final boolean DEBUG = Debug.PAGEARTICLE_DEBUG;
    private static final String TAG = "PageArticleActivity";
    ...
    private String mCurrentUrl = WebUrl.ACFUN_ARTICLE_URL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityTitle.setText(getString(R.string.article)+"   第 "+mCurrentPage+" 页");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        startActivity(new Intent(Defined.ACTION_ACTIVITY_VIEWARTICLE)
    ...
    private void parseArticle(final String acfunUrl) {
        // TODO Auto-generated method stub
            ...
            public void run() {
                ...
                try {
                    ...
                    for (Element element : elements) {
                        ...
                        mTmpTime.add(element.getElementsByAttributeValueStarting("class","time").first().text());
        ...
        switch (v.getId()) {
            ...
            case R.id.menu_back:
                if (mCurrentPage == 1) {
                    ...
                    mCurrentPage = 1;
                    mCurrentUrl = WebUrl.ACFUN_ARTICLE_URL;
                    parseArticle(WebUrl.ACFUN_ARTICLE_URL);
                } else {
                    mCurrentPage--;
                    //mCurrentUrl.replace("", replacement);
                    mCurrentUrl = "http://www.acfun.tv/v/list63/index_"+mCurrentPage+".htm";
                    parseArticle(mCurrentUrl);
                }
                mActivityTitle.setText(getString(R.string.article)+"   第 "+mCurrentPage+" 页");
                break;
