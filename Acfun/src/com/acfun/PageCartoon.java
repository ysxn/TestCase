...
public class PageCartoon extends ListActivity implements OnClickListener {
    private static final boolean DEBUG = Debug.PAGECARTOON_DEBUG;
    private static final String TAG = "PageCartoonActivity";
    ...
    private String mCurrentUrl = WebUrl.ACFUN_CARTOON_URL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityTitle.setText(getString(R.string.cartoon)+"   第 "+mCurrentPage+" 页");
    ...
    private void parseCartoon(final String acfunUrl) {
        // TODO Auto-generated method stub
        if (DEBUG) Log.i(TAG, ">>>>>>>>parseCartoon");
        ...
        switch (v.getId()) {
            ...
            case R.id.menu_back:
                if (mCurrentPage == 1) {
                    ...
                    mCurrentPage = 1;
                    mCurrentUrl = WebUrl.ACFUN_CARTOON_URL;
                    parseCartoon(WebUrl.ACFUN_CARTOON_URL);
                } else {
                    mCurrentPage--;
                    //mCurrentUrl.replace("", replacement);
                    mCurrentUrl = "http://www.acfun.tv/v/list67/index_"+mCurrentPage+".htm";
                    parseCartoon(mCurrentUrl);
                }
                mActivityTitle.setText(getString(R.string.cartoon)+"   第 "+mCurrentPage+" 页");
                break;
