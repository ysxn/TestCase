...
public class PageGame extends ListActivity implements OnClickListener {
    private static final boolean DEBUG = Debug.PAGEGAME_DEBUG;
    private static final String TAG = "PageGameActivity";
    ...
    private String mCurrentUrl = WebUrl.ACFUN_GAME_URL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityTitle.setText(getString(R.string.game)+"   第 "+mCurrentPage+" 页");
    ...
    private void parseGame(final String acfunUrl) {
        // TODO Auto-generated method stub
        if (DEBUG) Log.i(TAG, ">>>>>>>>parseGame");
        ...
        switch (v.getId()) {
            ...
            case R.id.menu_back:
                if (mCurrentPage == 1) {
                    ...
                    mCurrentPage = 1;
                    mCurrentUrl = WebUrl.ACFUN_GAME_URL;
                    parseGame(WebUrl.ACFUN_GAME_URL);
                } else {
                    mCurrentPage--;
                    //mCurrentUrl.replace("", replacement);
                    mCurrentUrl = "http://www.acfun.tv/v/list59/index_"+mCurrentPage+".htm";
                    parseGame(mCurrentUrl);
                }
                mActivityTitle.setText(getString(R.string.game)+"   第 "+mCurrentPage+" 页");
                break;
