...
public class PageMusic extends ListActivity implements OnClickListener {
    private static final boolean DEBUG = Debug.PAGEMUSIC_DEBUG;
    private static final String TAG = "PageMusicActivity";
    ...
    private String mCurrentUrl = WebUrl.ACFUN_MUSIC_URL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityTitle.setText(getString(R.string.music)+"   第 "+mCurrentPage+" 页");
    ...
    private void parseMusic(final String acfunUrl) {
        // TODO Auto-generated method stub
        if (DEBUG) Log.i(TAG, ">>>>>>>>parseMusic");
        ...
        switch (v.getId()) {
            ...
            case R.id.menu_back:
                if (mCurrentPage == 1) {
                    ...
                    mCurrentPage = 1;
                    mCurrentUrl = WebUrl.ACFUN_MUSIC_URL;
                    parseMusic(WebUrl.ACFUN_MUSIC_URL);
                } else {
                    mCurrentPage--;
                    //mCurrentUrl.replace("", replacement);
                    mCurrentUrl = "http://www.acfun.tv/v/list58/index_"+mCurrentPage+".htm";
                    parseMusic(mCurrentUrl);
                }
                mActivityTitle.setText(getString(R.string.music)+"   第 "+mCurrentPage+" 页");
                break;
