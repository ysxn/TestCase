...
public class PageEntertainment extends ListActivity implements OnClickListener {
    private static final boolean DEBUG = Debug.PAGEENTERTAINMENT_DEBUG;
    private static final String TAG = "PageEntertainmentActivity";
    ...
    private String mCurrentUrl = WebUrl.ACFUN_ENTERTAINMENT_URL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityTitle.setText(getString(R.string.entertainment)+"   第 "+mCurrentPage+" 页");
        ...
        parseEntertainment(mCurrentUrl);
    }
    ...
    private void parseEntertainment(final String acfunUrl) {
        // TODO Auto-generated method stub
        if (DEBUG) Log.i(TAG, ">>>>>>>>parseEntertainment");
        ...
        switch (v.getId()) {
            ...
            case R.id.menu_back:
                if (mCurrentPage == 1) {
                    ...
                    mCurrentPage = 1;
                    mCurrentUrl = WebUrl.ACFUN_ENTERTAINMENT_URL;
                    parseEntertainment(WebUrl.ACFUN_ENTERTAINMENT_URL);
                } else {
                    mCurrentPage--;
                    //mCurrentUrl.replace("", replacement);
                    mCurrentUrl = "http://www.acfun.tv/v/list60/index_"+mCurrentPage+".htm";
                    parseEntertainment(mCurrentUrl);
                }
                mActivityTitle.setText(getString(R.string.entertainment)+"   第 "+mCurrentPage+" 页");
                break;
