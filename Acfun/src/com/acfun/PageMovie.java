...
public class PageMovie extends ListActivity implements OnClickListener {
    private static final boolean DEBUG = Debug.PAGEMOVIE_DEBUG;
    private static final String TAG = "PageMovieActivity";
    ...
    private String mCurrentUrl = WebUrl.ACFUN_MOVIE_URL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityTitle.setText(getString(R.string.movie)+"   第 "+mCurrentPage+" 页");
    ...
    private void parseMovie(final String acfunUrl) {
        // TODO Auto-generated method stub
        if (DEBUG) Log.i(TAG, ">>>>>>>>parseMovie");
        ...
        switch (v.getId()) {
            ...
            case R.id.menu_back:
                if (mCurrentPage == 1) {
                    ...
                    mCurrentPage = 1;
                    mCurrentUrl = WebUrl.ACFUN_MOVIE_URL;
                    parseMovie(WebUrl.ACFUN_MOVIE_URL);
                } else {
                    mCurrentPage--;
                    //mCurrentUrl.replace("", replacement);
                    mCurrentUrl = "http://www.acfun.tv/v/list68/index_"+mCurrentPage+".htm";
                    parseMovie(mCurrentUrl);
                }
                mActivityTitle.setText(getString(R.string.movie)+"   第 "+mCurrentPage+" 页");
                break;
