    ...
    public void run() {
        try {
            while (bConnected) {
                    ...
                    for (int i = 0; i < getList.size(); i++) {
                        ...
                        for (Iterator<Map.Entry<Object, Object>> it = set.iterator(); it.hasNext();) {
                            ...
                            if (entry.getKey().equals("cmContent"))
                                cmContent = (String) entry.getValue();
                            else if (entry.getKey().equals("cmFrom"))
                                cmFrom = (String) entry.getValue();
                            else if (entry.getKey().equals("cmPostdate")) {
                                cmPostdate = "  [" + df.format(entry.getValue()) + "]";
                            }
                            else if (entry.getKey().equals("cmID"))
                                cmID = (Long) entry.getValue();
                        }
                ...
                // chat for handle
                    ...
                    if (forend > 0) {
                        ...
                        if (issend > 0) {
                            ...
                            // send to me
                            // DataOutputStream ndos2 = new DataOutputStream
                            // (Server.socketMap.get(fromname).getOutputStream());
                ...
                // for (Iterator iterator=Server.onlineMap.entrySet().iterator();
                // iterator.hasNext();) {
                // Map.Entry elementEntry = (Map.Entry) iterator.next();
                // String strKeyObject = (String) elementEntry.getKey();
                ...
                // for (Iterator iterator=Server.socketMap.entrySet().iterator();
                // iterator.hasNext();) {
                // Map.Entry elementEntry = (Map.Entry) iterator.next();
                // String strKeyObject = (String) elementEntry.getKey();
                // Socket strObject = (Socket) elementEntry.getValue();
