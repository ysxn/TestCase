...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-shared --enable-cross-compile --strip='C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-strip' --cc='C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc' --cross-prefix='C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-' --extra-cflags='-fPIC -DANDROID' --extra-ldflags='-Wl,-T,C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/windows/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=C:/android-ndk/platforms/android-8/arch-arm/usr/lib -LC:/android-ndk/platforms/android-8/arch-arm/usr/lib -nostdlib C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/windows/lib/gcc/arm-eabi/4.4.0/crtbegin.o C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/windows/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl' --enable-version3 --disable-gpl --disable-nonfree --disable-debug --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-encoders --disable-muxers --disable-devices --disable-protocols --enable-protocol=file --enable-swscale --disable-avfilter --disable-network --disable-avdevice --enable-parsers --enable-decoders --enable-demuxers
prefix=/usr/local
...
CC_IDENT=gcc 4.4.3 (GCC)
ARCH=arm
CC=C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
CXX=C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-g++
AS=C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
LD=C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCC=C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ar
RANLIB=C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-strip
CPPFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
CFLAGS= -fPIC -DANDROID  -std=c99 -fomit-frame-pointer -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -fPIC -DANDROID 
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -Wl,-T,C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/windows/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=C:/android-ndk/platforms/android-8/arch-arm/usr/lib -LC:/android-ndk/platforms/android-8/arch-arm/usr/lib -nostdlib C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/windows/lib/gcc/arm-eabi/4.4.0/crtbegin.o C:/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/windows/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
