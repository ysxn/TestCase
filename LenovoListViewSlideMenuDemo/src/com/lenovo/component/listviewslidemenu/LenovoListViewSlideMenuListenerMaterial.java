        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mSwipeStatus == SWIPE_STAT_IDLE ) {
                    ...
                    if (downV != null && downV instanceof LenovoListViewSlideMenuGroupViewMaterial) {
                        mTouchDownListItemViewGroup = (LenovoListViewSlideMenuGroupViewMaterial) downV;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mSwipeStatus == SWIPE_STAT_PROCESS) {
                    ...
                    if (deltaX > 0 && (deltaX > (mTouchDownListItemViewGroup.getRightMenuWidth() / 2) || (velocityEnoughToFling && v_x < 0))) {
                        ...
                        mTouchDownListItemViewGroup.setMenuClickListener(new LenovoListViewSlideMenuGroupViewMaterial.OnMenuClickListener() {
                            
                            @Override
                            public void onMenuClicked(LenovoListViewSlideMenuGroupViewMaterial listItemViewGroup) {
                                // TODO Auto-generated method stub
                                scrollBack();
                            }
                        });
    ...
    private View getFocusChild(int x, int y) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (rect.contains(view_x, view_y)) {
                if (child instanceof LenovoListViewSlideMenuGroupViewMaterial) {
                    return child;
                }
            }
        }
