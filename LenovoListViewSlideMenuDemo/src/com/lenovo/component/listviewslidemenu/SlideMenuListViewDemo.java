...
public class SlideMenuListViewDemo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listviewslidemenu_activity_slidesection);
	...
	private class EfficientAdapter extends BaseAdapter {
        ...
        public EfficientAdapter(Context context) {
            ...
            mIcon1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.listviewslidemenu_ic_demo_1);
            mTwoSlideMenuOneSide = getApplicationContext().getResources().getBoolean(R.bool.listviewslidemenu_use_two_slide_menu_item_one_side);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            // by ListView is null.
            if (convertView == null) {               
                LenovoSlideMenuGroupView sectionView = (LenovoSlideMenuGroupView)mInflater.inflate(R.layout.listviewslidemenu_list_item_slide_menu, null);
                View itemView = mInflater.inflate(R.layout.listviewslidemenu_list_item_icon_text_tip, null);
                // Creates a ViewHolder and store references to the two children views
                // we want to bind data to.
                holder = new ViewHolder();
                holder.position = position;
                holder.text = (TextView) itemView.findViewById(R.id.listviewslidemenu_text);
                holder.icon = (ImageView) itemView.findViewById(R.id.listviewslidemenu_icon);
