...
public interface ICacheAble<T> {
    ...
    /**
     * We need to process the data from data source, do some filter of convert
     * the structure.
     * <p/>
     * As the "Assert Data" is a special data source, we also need to do the
     * same work.
     */
    ...
    /**
     * temporarily disable cache. The data will no be load from cache and will
     * also not be put into cache
     */
