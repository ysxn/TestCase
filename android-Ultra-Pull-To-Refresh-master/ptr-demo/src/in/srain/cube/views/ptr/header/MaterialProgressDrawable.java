...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private void setUp(final double diameter) {
        DisplayHelper.init(mParent.getContext());
        final int shadowYOffset = DisplayHelper.dp2px(Y_OFFSET);
        final int shadowXOffset = DisplayHelper.dp2px(X_OFFSET);
        int mShadowRadius = DisplayHelper.dp2px(SHADOW_RADIUS);
