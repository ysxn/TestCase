...
public class StoreHouseHeader extends View implements OnPullUIListener {
    ...
    private void initView() {
        ...
        mLineWidth = DisplayHelper.dp2px(1);
        mDropHeight = DisplayHelper.dp2px(40);
        mHorizontalRandomness = DisplayHelper.SCREEN_WIDTH_PIXELS / 2;
    }
    ...
    private int getTopOffset() {
        return getPaddingTop() + DisplayHelper.dp2px(10);
    }

    private int getBottomOffset() {
        return getPaddingBottom() + DisplayHelper.dp2px(10);
    }
    ...
    public void initWithPointList(ArrayList<float[]> pointList) {
        ...
        for (int i = 0; i < pointList.size(); i++) {
            ...
            PointF startPoint = new PointF(DisplayHelper.dp2px(line[0]) * mScale, DisplayHelper.dp2px(line[1]) * mScale);
            PointF endPoint = new PointF(DisplayHelper.dp2px(line[2]) * mScale, DisplayHelper.dp2px(line[3]) * mScale);
