 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_testjni_TestJni_getTargetWidth
  (JNIEnv * env, jclass thiz) 
{
    return target_width;
}
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_testjni_TestJni_getTargetHeight
  (JNIEnv * env, jclass thiz) 
{
 ...
 */
JNIEXPORT jint JNICALL Java_com_testjni_TestJni_openFile
 ...
 */
JNIEXPORT jint JNICALL Java_com_testjni_TestJni_drawFrame
 ...
 */
JNIEXPORT jint JNICALL Java_com_testjni_TestJni_drawFrameAt
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_testjni_TestJni_exit
  (JNIEnv *env, jclass thiz)
{
    if (buffer != NULL) 
    {
