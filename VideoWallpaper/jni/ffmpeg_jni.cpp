...
static const char * const kClassPathName = "com/zhuyawen/wallpaper/WrapFFmpeg";
...
//    int64_t seek_target;
    ...
    {
        if (debug) LOGI("while loop ret=%i",ret);
    ...
    if (debug) LOGI("drawFrame end ret =%i  i=%i",ret,i);
    return ret;
}
...
static JNINativeMethod gMethods[] = {
        ...
        {"native_getPts",    "()J",  (void *)Java_com_ffmpeg_jni_getPts},
};
