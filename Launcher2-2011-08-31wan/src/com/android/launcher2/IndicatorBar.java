...
public class IndicatorBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.translate(getWidth()/ 2, (float)(mDownRadius -50 / 1.5 * mDensity));
        canvas.drawCircle(0, 0, (float)(mDownRadius - 58 / 1.5 * mDensity), mPaint);
        canvas.restore();
        
        canvas.save();
        canvas.translate(getWidth()/ 2, (float)(mDownRadius + 12 / 1.5 * mDensity));
