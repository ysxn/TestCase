...
public class DragController {
    ...
    public void startDrag(View v, DragSource source, Object dragInfo, int dragAction, int lastX, int lastY) {
        mOriginator = v;
    ...
    private Bitmap convertViewToBitmap(View v) {
        ...
        return bitmap;
        /*
        Bitmap bit = Bitmap.createBitmap(v.getMeasuredWidth(), v.getMeasuredHeight(), Bitmap.Config.ARGB_8888);
