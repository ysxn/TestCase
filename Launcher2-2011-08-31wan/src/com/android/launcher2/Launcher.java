...
public final class Launcher extends Activity
    ...
    private static final int MENU_GROUP_ALLAPPS_VIEW = MENU_GROUP_ADD + 2;
    ...
    private static final int MENU_ALLAPPS_VIEWGRID = MENU_SETTINGS + 1;
    private static final int MENU_ALLAPPS_VIEWLIST = MENU_ALLAPPS_VIEWGRID + 1;
    ...
    private ViewGroup mAllAppsButtonCluster;
    ...
    private IndicatorBar mScrollerbarForHtc;
    ...
    */
    ...
    private void setupViews() {
        ...
        mIndicatorBar = (IndicatorBar) findViewById(R.id.scrollerbar_for_htc);

        mAllAppsButtonCluster= (ViewGroup) findViewById(R.id.all_apps_button_cluster);
        
        //ImageView hotseatCenter = (ImageView) findViewById(R.id.hotseat_center);
        //hotseatCenter.setContentDescription(mHotseatLabels[0]);
        //hotseatCenter.setImageDrawable(mHotseatIcons[0]);
        ImageView hotseatRight = (ImageView) findViewById(R.id.hotseat_right);
        hotseatRight.setContentDescription(mHotseatLabels[1]);
        hotseatRight.setImageDrawable(mHotseatIcons[1]);
        //ImageView hotseatLeft2D = (ImageView) findViewById(R.id.hotseat_left_2d);
        //hotseatLeft2D.setContentDescription(mHotseatLabels[0]);
        //hotseatLeft2D.setImageDrawable(mHotseatIcons[0]);
        /*
        ImageView hotseatRight2D = (ImageView) findViewById(R.id.hotseat_right_2d);
        hotseatRight2D.setContentDescription(mHotseatLabels[1]);
        hotseatRight2D.setImageDrawable(mHotseatIcons[1]);
        */

        mPreviousView = (ImageView) dragLayer.findViewById(R.id.previous_screen);
        mNextView = (ImageView) dragLayer.findViewById(R.id.next_screen);
        mScrollerbarForHtc = (IndicatorBar) dragLayer.findViewById(R.id.scrollerbar_for_htc);

        Drawable previous = mPreviousView.getDrawable();
        Drawable next = mNextView.getDrawable();
        mWorkspace.setIndicators(previous, next);
        mWorkspace.setHtcIndicators(mScrollerbarForHtc);
    ...
    public void launchHotSeat(View v) {
        ...
        int index = -1;//v.getId() == R.id.hotseat_center || v.getId() == R.id.hotseat_left_2d || 
        //
        if (v.getId() == R.id.hotseat_center_text || v.getId() == R.id.hotseat_center_text_2d) {
            index = 0;
        } else if (v.getId() == R.id.hotseat_right || v.getId() == R.id.hotseat_right_2d) {
            index = 1;
        }
    ...
    View createShortcutList(int layoutResId, ViewGroup parent, ShortcutInfo info) {
        TextView favorite = (TextView) mInflater.inflate(layoutResId, parent, false);
        favorite.setCompoundDrawablesWithIntrinsicBounds(null,
                new FastBitmapDrawable(info.getIcon(mIconCache)),
                null, null);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(MENU_GROUP_ALLAPPS_VIEW, MENU_ALLAPPS_VIEWGRID, 0, R.string.select_all_apps_grid)
                .setIcon(R.drawable.icon_menu_grid_view);
        menu.add(MENU_GROUP_ALLAPPS_VIEW, MENU_ALLAPPS_VIEWLIST, 0, R.string.select_all_apps_list)
                .setIcon(R.drawable.icon_menu_list_view);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.setGroupVisible(MENU_GROUP_ALLAPPS_VIEW, !visible);

        boolean isgrid = mAllAppsGrid.isGrid();
        menu.findItem(MENU_ALLAPPS_VIEWGRID).setVisible(!visible && !isgrid);
        menu.findItem(MENU_ALLAPPS_VIEWLIST).setVisible(!visible && isgrid);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_NOTIFICATIONS:
                showNotifications();
                return true;
            case MENU_ALLAPPS_VIEWGRID:
                mAllAppsGrid.selectView(true);
                return true;
            case MENU_ALLAPPS_VIEWLIST:
                mAllAppsGrid.selectView(false);
                return true;
        }
...
//        }
    ...
    void shadeAllApps(boolean animated) {
        if (mAllAppsGrid.isVisible()) {
            mWorkspace.setVisibility(animated ? View.VISIBLE : View.GONE);
        }
    }
