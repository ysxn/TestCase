...
import com.android.launcher2.IndicatorBar;
...
public class Workspace extends ViewGroup implements DropTarget, DragSource, DragScroller {
    ...
    void setCurrentScreen(int currentScreen) {
        ...
        //mScrollerbarForHtc.setAlphaHtc(mCurrentScreen);
    ...
    public void computeScroll() {
        ...
        mScrollerbarForHtc.setAlphaHtc(mCurrentScreen, mScrollX);
    }
            ...
            if (mTouchState == TOUCH_STATE_SCROLLING) {
                ...
                if (deltaX < 0) {
                    if (mTouchX > 0) {
                        ...
                        mSmoothingTime = System.nanoTime() / NANOTIME_DIV;
                        //mScrollerbarForHtc.setAlphaHtc(mCurrentScreen, deltaX);
                        invalidate();
                    }
                } else if (deltaX > 0) {
    ...
    private void snapToScreen(int whichScreen, int velocity, boolean settle) {
        ...
        //mScrollerbarForHtc.setAlphaHtc(mNextScreen);
        //mScrollerbarForHtc.setAlphaHtcAnimation(mNextScreen);
    ...
    void setHtcIndicators(IndicatorBar scrollerbarForHtc) {
        mScrollerbarForHtc = scrollerbarForHtc;
        scrollerbarForHtc.setAlphaHtc(mCurrentScreen);
    }
