...
public class config{
	...
	public static String url = "jdbc:mysql://localhost:3306/pgm5?useUnicode=true&characterEncoding=utf8"; 
	public static String username = "pgm5"; 
	public static String password = "pgm5"; 
	public static String tableName = "db_login" ;
}