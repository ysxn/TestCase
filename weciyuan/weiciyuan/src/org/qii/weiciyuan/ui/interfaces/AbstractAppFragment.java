...
public class AbstractAppFragment extends FixedOnActivityResultBugFragment {
    ...
    protected final int SCREEN_ROTATE = 1; // when activity is destroyed and recreated because a
                                           // configuration change, see setRetainInstance(boolean
                                           // retain)
    protected final int ACTIVITY_DESTROY_AND_CREATE = 2; // when activity is destroyed because
                                                         // memory is too low, recycled by android
                                                         // system
