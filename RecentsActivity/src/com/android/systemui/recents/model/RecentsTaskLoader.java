...
public class RecentsTaskLoader {
    ...
    private static List<ActivityManager.RecentTaskInfo> getRecentTasks(
        ...
        List<ActivityManager.RecentTaskInfo> tasks = new ArrayList<ActivityManager.RecentTaskInfo>();
    ...
    public SpaceNode reload(Context context, int preloadCount, boolean isTopTaskHome) {
        ...
        TaskStack stack = getTaskStack(context.getResources(),
    ...
    public TaskStack getTaskStack(Resources res,
        ...
        RecentsConfiguration config = RecentsConfiguration.getInstance();
        List<ActivityManager.RecentTaskInfo> tasks = getRecentTasks(isTopTaskHome);
        ...
        for (int i = 0; i < taskCount; i++) {
            ...
            Task.TaskKey taskKey = new Task.TaskKey(t.persistentId, t.baseIntent, 0,
                    0, 0);
            ...
            Task task = new Task(taskKey, (t.id > -1), t.affiliatedTaskId, 0/*t.affiliatedTaskColor*/,
