...
public class Android_exercise_edit_activity extends Activity {
	...
	private TextView contactor_id = null;
	...
	private String TAG = "Android_exercise_edit_activity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(factory.inflate(R.layout.edit, null));
        ...
        contactor_id = (TextView) findViewById(R.id.contactor_ID);
        ...
        if (intent.getData() == null) {
            ...
            Log.i("zhuyawen ;Android_exercise_edit_activity ;intent.getData() if", intent.getData().toString());
        }
        else
        {
        	Log.i("zhuyawen ;Android_exercise_edit_activity ;intent.getData() else", intent.getData().toString());
        	
        }
        data = intent.getData();
        
        if (!intent.getData().equals(calling_card.calling_card_contactors.CONTENT_URI))
        {
        	prev.setVisibility(android.view.View.INVISIBLE );
        	next.setVisibility(android.view.View.INVISIBLE );
        }
        
        Log.i("zhuyawen ;Android_exercise_edit_activity ;intent.getData() after", intent.getData().toString());
        getcursor_forall();
    ...
    private void updatedisplay()
    {
    	...
    	contactor_id.setText(Integer.toString(c.getPosition() + 1) + "/" + Integer.toString(c.getCount()));
    }
    
    private void getcursor_forall()
    {
    	c = managedQuery(intent.getData(), 
        		columns, 
        		null, 
        		null, 
