...
public class FriendsListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Cursor cursor = db.query("config", new String[] {
                    "ip", "name", "port"
    ...
    public void connect() {
        try {
            ...
            if (s.isConnected()) {
                ...
                /**
                 * 这里是关键，我在此耗时8h+ 原因是 子线程不能直接更新UI 为此，我们需要通过Handler物件，通知主线程Ui Thread来更新界面。
                 */
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        // Toast.makeText(MyListViewActivity.this, (String)mData.get(position).get("text"),
