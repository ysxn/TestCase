...
public class TileOverlayDemo extends Activity {
    ...
    private void onlineTile() {
        ...
        /**
         * 定义瓦片图的在线Provider，并实现相关接口 MAX_LEVEL、MIN_LEVEL 表示地图显示瓦片图的最大、最小级别 urlString 表示在线瓦片图的URL地址
         */
    ...
    private void offlineTile() {
        ...
        /**
         * 定义瓦片图的离线Provider，并实现相关接口 MAX_LEVEL、MIN_LEVEL 表示地图显示瓦片图的最大、最小级别 Tile 对象表示地图每个x、y、z状态下的瓦片对象
         */
