...
/**
 * IconGenerator generates icons that contain text (or custom content) within an info window-like
 * shape.
 * <p/>
 * The icon {@link Bitmap}s generated by the factory should be used in conjunction with a
 * {@link com.baidu.mapapi.map.BitmapDescriptorFactory}.
 * <p/>
...
public class IconGenerator {
     ...
     * <p/>
     * If the view contains a {@link TextView} with the id "text", operations such as
     * {@link #setTextAppearance} and {@link #makeIcon(String)} will operate upon that
     * {@link TextView}.
     */
