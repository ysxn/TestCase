...
public class HttpHelper {
    ...
    public static final int MSG_SHOW_RESULT = 0x3000;
     ...
     * HttpURLConnection比较繁琐
     */
    public void methodGet(String par, int requestType) {
        ...
        if (url != null) {
            try {
                ...
                Message msg = mHandler.obtainMessage(requestType, resultData);
                msg.sendToTarget();
            } catch (IOException e) {
     ...
     */
    public void methodHttpGet(String passUrl, int requestType) {
        String httpUrl = passUrl;
        if (passUrl == null) {
        	Message msg = mHandler.obtainMessage(requestType, "");
            msg.sendToTarget();
            return;
        }
        Log.i("zzz", "get="+httpUrl);
        ...
        try {
            ...
            Log.i(TAG, ">>>>HttpStatus :" + httpResponse.getStatusLine().getStatusCode());
            // 请求成功
     ...
     * 另外，在使用POST方式进行传输时，需要进行字符编码。
     */
    public void methodHttpPost(String httpUrl, List<NameValuePair> params, String email, String pass) {
        Bundle bundle = new Bundle();
        // http地址
        if (httpUrl == null || httpUrl.isEmpty()) {
            bundle.putBoolean(IS_ERROR, true);
            bundle.putString(RESULT_DATA, "httpUrl is null");
            Message msg = mHandler.obtainMessage(MSG_SHOW_RESULT, bundle);
            msg.sendToTarget();
            return;
        }
        String resultData = null;
        ...
        try {
            ...
            bundle.putString(RESULT_DATA, resultData);
