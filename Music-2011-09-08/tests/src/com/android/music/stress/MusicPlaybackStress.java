 ...
 */
package com.android.musicsss.tests.stress;
...
import com.android.musicsss.MusicBrowserActivity;
...
public class MusicPlaybackStress extends ActivityInstrumentationTestCase <TrackBrowserActivity>{
    ...
    public MusicPlaybackStress() {
      super("com.android.musicsss",TrackBrowserActivity.class);
    }
    ...
    public void testPlayAllSongs() {
      ...
      try{
        ...
        ActivityMonitor mediaPlaybackMon = inst.addMonitor("com.android.musicsss.MediaPlaybackActivity", 
          null, false);
